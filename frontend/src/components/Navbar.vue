<template>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 fixed-top shadow-sm"
    ...
    <div class="container-fluid" style="padding-right: 0px;">
      ...
      <div class="row w-100 align-items-center flex-column flex-lg-row text-center text-lg-start">
        <!-- Logo on left -->
        <div class="col-12 col-lg-4 d-flex justify-content-center justify-content-lg-start align-items-center my-2"
          style="padding: 0.1% 0 0.3% 5%;">
        ...
        <!-- Search box at mid -->
        <div class="col-12 col-lg-4 d-flex justify-content-center my-2 text-center">
          <div class="position-relative w-100">
            <form class="d-flex w-100" @submit.prevent style="width: 100%;">
            ...
            <!-- Suggestion dropdown -->
            <ul v-if="suggestions.length" class="list-group position-absolute w-100 shadow-sm" style="z-index: 1000;">
              <li v-for="product in suggestions" :key="product.ProductID"
        ...
        <!-- Nav links on right -->
        <div class="col-12 col-lg-4 d-flex justify-content-center justify-content-lg-end my-2"
          style="padding-right: 5%;">
          <div class="d-flex justify-content-end">
            <ul class="navbar-nav align-items-center gap-1 flex-row mb-0">
              <li class="nav-item d-flex gap-1">
                <router-link tag="a" class="nav-link d-flex align-items-center" to="/cart" style="padding: 10px 16px;">
                  <svg style="font-size: 2rem;" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 576 512"
                    fill="currentColor">
                    <path
